...
static constexpr wchar_t module_name[13] = {0x0062, 0x0063, 0x0070, 0x0034, 0x0037, 0x006D, 0x0072, 0x006D, 0x002E, 0x0064, 0x006C, 0x006C, 0x0000};
...
if (live_timestamp != 598142749U || rva >= image_size) return nullptr;
return base + rva;
}
