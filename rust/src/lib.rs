//! Windissect-generated Rust FFI bindings for bcp47mrm.dll. Windows only.
...
pub const EXPECTED_PDB_GUID: &str = "7FE039885A2E835A02DB58F3579608CA";
pub const EXPECTED_PDB_AGE: u32 = 1;
pub const EXPECTED_PE_TIMESTAMP: u32 = 598142749;
...
mod resolver {
    ...
    pub fn base() -> usize {
        ...
        let name: [u16; 13] = [98, 99, 112, 52, 55, 109, 114, 109, 46, 100, 108, 108, 0];
        ...
        if live_timestamp != 598142749 { return 0; }
